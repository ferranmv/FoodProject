...
<!--								<a href="#" class="btn btn-primary"><i class="linecons-cog"></i> Edit Profile</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="user-info-sidebar">
                                ...
                                <div class="wrapper">
                                    <a href="<?php echo $this->config->item('base_url').'user/userprofile'; ?>" ><i class="linecons-cog"></i> Profile</a>	
                                </div>
                        ...
                        <div class="col-sm-9">
							...
							<form id="edit_profile_form" role="form" class="form-horizontal">
								
								<div class="form-group">
									<label class="col-sm-2 control-label" for="first_name">First Name</label>
									
									<div class="col-sm-4">
										<input class="form-control" id="first_name" placeholder="Placeholder" type="text">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input class="form-control" id="last_name" placeholder="Placeholder" type="text">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input class="form-control" id="email" placeholder="Enter your email…" type="email" disabled="">
										<p class="help-block">We will send you the notifications to this email.</p>
									</div>
								</div>
							...
							<div class="col-sm-4">
                                                            <input class="form-control" id="country" placeholder="Country" type="text" disabled="">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input class="form-control" id='facebook_link' placeholder="www.facebook.com/ferranmv" disabled="" type="text">
									</div>
                                                                        <label class="col-sm-1 control-label">
                                                                            <a href='' id='facebook_visit_link' target='_blank'>
                                                                            visit
                                                                            </a>
                                                                        </label>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="website_link">Website</label>
									
									<div class="col-sm-4">
										<input class="form-control" id="website_link" placeholder="enter your blog/website address" type="text">
									</div>
								</div>

																
								<div class="form-group">
									<label class="col-sm-2 control-label" for="about_me">About</label>
									
									<div class="col-sm-8">
										<textarea style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 64px; width: 428px;" class="form-control autogrow" cols="5" id="about_me" placeholder="describe yourself ..."></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
	    								<button class="btn btn-primary btn-single" type="button" onclick='UserController.updateEditProfileFields();'> Save Changes</button>
	    							</div>
							...
							<h4>Close Account</h4>
								...
								<p>Click <a href="javascript:;" onclick="jQuery('#CloseAccount').modal('show', {backdrop: 'fade'});">here</a> if you wish to delete your account</p>
        ...
        <script>
            ...
            UserController.updateUserEditProfileFieldsIOnLoad(<?php echo $user_profile ?>);
