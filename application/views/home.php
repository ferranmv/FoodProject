...
<body class="page-body right-sidebar boxed-container">
	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="main-content">
			...
			<div class="row">
				<div class="panel panel-question panel-default panel-border panel-shadow"><!-- Add class "collapsed" to minimize the panel -->
					<div class="panel-heading" >
						<h2 class="panel-title" id="question_title"></h2>

							
						<div class="panel-options">
							<a href="javascript:;" onclick="jQuery('#rules').modal('show', {backdrop: 'fade'});"><i class="fa-gamepad"></i></a>	

						</div>
					</div>
					
					<div class="panel-body" id="question_background_image">
						<div class="contentInstruction">HOVER</div>
						<div class="contentAnswer">
							...
							<div class="col-sm-9"> 
									<br><br>
										...
										<div class="form-block" id="question_choices" > 
			...
			<div class="cuisine">			
				<div class="col-sm-8"> <div class="toRight">Filter questions: </div></div>
				<div class="col-sm-4"> 
					<form role="form">
							<div class="form-group">
											...
											<select class="form-control" id="s2example-3">
												...
												<option value="in">Indian Food</option>
												<option value="cn">Chinese Food</option>
												<option value="es">Spanish Food</option>
												<option value="fr">French Food</option>
												<option value="us">American Food</option>
											</select>
	...
	<script src="<?php echo ROOT_URL ?>assets/js/xenon-custom.js"></script>
        ...
        <?php } ?>
         ...
         <script>                        
                        ...
                        MiscController.populateDrownDownMenu();
                        MiscController.populateCuisines();
                         QuestionAnswerController.fetchQuestion();
